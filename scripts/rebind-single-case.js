...
function sanitizeDiagnostics(error) {
  ...
  for (const code of [
    ...
    "REBIND_NEW_PAIR_CONSUMED", "REBIND_NEW_PAIR_REVOKED", "REBIND_NEW_PAIR_EXPIRED",
    "REBIND_NEW_PAIR_INSUFFICIENT_REMAINING_TTL", "REBIND_NEW_PAIR_TYPES_INVALID", "REBIND_NEW_BINDINGS_MISMATCH",
