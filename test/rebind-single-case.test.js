        ...
        if (sql.includes("pg_constraint")) {
          return {
            ...
            rows: [
              ...
              { conname: "single_case_rebind_audit_reason_check", contype: "c", definition: "CHECK ((reason = ANY(ARRAY['CONTACT_RECONCILED_AFTER_DIVERGENCE'::text, 'PLAN_REGENERATED_AFTER_SAFE_CORRECTION'::text, 'AUTHORIZATION_PAIR_REFRESHED_AFTER_EXPIRY'::text])))", columns: JSON.stringify(["reason"]) },
