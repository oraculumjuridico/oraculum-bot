...
async function harness() {
  ...
  const plan = { schemaVersion: 1, caseImportId, safeToPlanHubSpot: true, safeToApply: false, contactPlan: { properties: { firstname: "Cliente Ficticio", cpf_do_cliente: "fixture", phone: "fixture" } }, dealPlan: { caseNumber, properties: { numero_de_caso: caseNumber, area_juridica: "Previdenciário (INSS)", pipeline: "fixture", dealstage: "fixture" } }, documentPlan: { physicalOccurrences: 14, uniqueContents: 12 }, caseNumberReservationSync: { source: "OFFICIAL_POSTGRES_RESERVATION" } }
