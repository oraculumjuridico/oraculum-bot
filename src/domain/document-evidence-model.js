...
function criarEvidenciaDocumental(input = {}) {
  ...
  return {
    ...
    quality: sanitizarPersistivel(input.quality) ?? null,
    extracao,
    coverage: normalizarCoverage(input.coverage),
    requirementId: texto(input.requirementId) || null,
    partyRole: texto(input.partyRole) || null,
    partyResolutionStatus: texto(input.partyResolutionStatus) || null,
