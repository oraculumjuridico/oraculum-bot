...
function logInfo(evento = {}) {
  ...
  for (const key of ["providerMessageId", "action", "channel", "fallback", "failureCode", "failureDescription", "queue", "stages", "receivedCount", "hubspotTotal", "after", "filteredCount", "errorCode", "operation", "searchType", "httpStatus", "resultsIsArray", "rawResultCount", "total", "hasPaging"]) {
